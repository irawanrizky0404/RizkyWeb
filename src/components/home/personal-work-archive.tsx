...
export function PersonalWorkArchive({ projects }: PersonalWorkArchiveProps) {
  ...
  return (
    <div ref={containerRef} className="relative w-full h-screen bg-black overflow-hidden">
      ...
      {/* CINEMASCOPE BARS */}
      <div className="absolute top-0 left-0 right-0 z-40 bg-black" style={{ height: "12px" }} />
      <div className="absolute bottom-0 left-0 right-0 z-40 bg-black" style={{ height: "12px" }} />
      ...
      <div className="absolute right-4 top-1/2 -translate-y-1/2 z-40 flex flex-col gap-2">
        {personalProjects.map((p, i) => (
          <button
            ...
            className="relative w-2 h-8 transition-all duration-500 overflow-hidden"
      ...
      {/* MOBILE NAV - BOTTOM */}
      <div className="md:hidden absolute bottom-8 left-0 right-0 z-40">

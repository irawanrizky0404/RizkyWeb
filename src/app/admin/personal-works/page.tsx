...
function PersonalWorkListItem({ work, onEdit, onDelete, onToggleFeatured, isPending }: {
  work: Project;
  onEdit: () => void;
  onDelete: () => void;
...
// ── Personal Work Card ─────────────────────────────────────────────────────────────────
function PersonalWorkCard({ work, onEdit, onDelete, onToggleFeatured, isPending }: {
  work: Project;
  onEdit: () => void;
  onDelete: () => void;
  onToggleFeatured: () => void;

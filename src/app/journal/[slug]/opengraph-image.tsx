    ...
    (
      <div style={{ width: "100%", height: "100%", background: "#080808", display: "flex", flexDirection: "column", justifyContent: "space-between", padding: "60px 72px", fontFamily: "monospace" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
          <span style={{ color: "#ff3500", fontSize: "14px", letterSpacing: "0.2em", textTransform: "uppercase" }}>FAC.J</span>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          <span style={{ color: "#f0f0ee", fontSize: "90px", fontWeight: 700, lineHeight: 0.95, letterSpacing: "0.02em", textTransform: "uppercase", whiteSpace: "pre-wrap" }}>
            {post?.title ?? slug}
          </span>
        </div>
